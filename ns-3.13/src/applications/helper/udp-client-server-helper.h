...
// Added by Abdallah Abdallah May 12, 2012
class RateAdaptiveSenderHelper
{
public:
  /**
   * Create RateAdaptiveSenderHelper which will make life easier for people trying
   * to set up simulations with rate adaptive streaming sender client.
   *
   */
	RateAdaptiveSenderHelper ();
  ...
  /**
    * \param c the nodes
    *
    * Create one rate adaptive sender client application on each of the input nodes
    *
    * \returns the applications created, one application per input node.
    */
  ApplicationContainer Install (NodeContainer c);
