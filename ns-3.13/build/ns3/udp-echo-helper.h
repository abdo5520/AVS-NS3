 ...
 * to implement the helpder for the rate-adaptive-receiver
 * Client application
 */
 ...
 *        and sends them back to the original sender.
 */
class RateAdaptiveReceiverHelper
{
public:
  /**
   * Create RateAdaptiveReceiverHelper which will make life easier for people trying
   * to set up simulations with RateAdaptiveReceiver.
   *
   * \param port The port the server will wait on for incoming packets
   */
	RateAdaptiveReceiverHelper (uint16_t port);
  ...
  /**
   * Create a RateAdaptiveReceiverApplication on the specified Node.
   *
   * \param node The node on which to create the Application.  The node is
   *             specified by a Ptr<Node>.
   *
  ...
  /**
   * Create a RateAdaptiveReceiverApplication on specified node
   *
   * \param nodeName The node on which to create the application.  The node
   *                 is specified by a node name previously registered with
   *                 the Object Name Service.
