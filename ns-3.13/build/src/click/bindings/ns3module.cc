#include "ns3module.h"
static PyMethodDef click_FatalImpl_functions[] = {
    {NULL, NULL, 0, NULL}
};

static PyObject *
initclick_FatalImpl(void)
{
    PyObject *m;
    m = Py_InitModule3((char *) "click.FatalImpl", click_FatalImpl_functions, NULL);
    if (m == NULL) {
        return NULL;
    }
    return m;
}
static PyMethodDef click_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
static int
_wrap_PyNs3Ipv4L3ClickProtocol__tp_init(void)
{
    PyErr_SetString(PyExc_TypeError, "class 'Ipv4L3ClickProtocol' cannot be constructed (have pure virtual methods but no helper class)");
    return -1;
}

static PyMethodDef PyNs3Ipv4L3ClickProtocol_methods[] = {
    {NULL, NULL, 0, NULL}
};

static void
PyNs3Ipv4L3ClickProtocol__tp_clear(PyNs3Ipv4L3ClickProtocol *self)
{
    Py_CLEAR(self->inst_dict);
    if (self->obj) {
    ns3::Ipv4L3ClickProtocol *tmp = self->obj;
    self->obj = NULL;
    tmp->Unref();
}
}
...
static int
PyNs3Ipv4L3ClickProtocol__tp_traverse(PyNs3Ipv4L3ClickProtocol *self, visitproc visit, void *arg)
{
...
static void
_wrap_PyNs3Ipv4L3ClickProtocol__tp_dealloc(PyNs3Ipv4L3ClickProtocol *self)
{
    ...
    PyNs3Ipv4L3ClickProtocol__tp_clear(self);
    self->ob_type->tp_free((PyObject*)self);
}

static PyObject*
_wrap_PyNs3Ipv4L3ClickProtocol__tp_richcompare (PyNs3Ipv4L3ClickProtocol *PYBINDGEN_UNUSED(self), PyNs3Ipv4L3ClickProtocol *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3Ipv4L3ClickProtocol_Type)) {
...
PyTypeObject PyNs3Ipv4L3ClickProtocol_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "click.Ipv4L3ClickProtocol",            /* tp_name */
    sizeof(PyNs3Ipv4L3ClickProtocol),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3Ipv4L3ClickProtocol__tp_dealloc,        /* tp_dealloc */
    ...
    (traverseproc)PyNs3Ipv4L3ClickProtocol__tp_traverse,     /* tp_traverse */
    (inquiry)PyNs3Ipv4L3ClickProtocol__tp_clear,             /* tp_clear */
    (richcmpfunc)_wrap_PyNs3Ipv4L3ClickProtocol__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3Ipv4L3ClickProtocol_methods, /* tp_methods */
    ...
    offsetof(PyNs3Ipv4L3ClickProtocol, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3Ipv4L3ClickProtocol__tp_init,             /* tp_init */
...
static int
_wrap_PyNs3Ipv4ClickRouting__tp_init(void)
{
    PyErr_SetString(PyExc_TypeError, "class 'Ipv4ClickRouting' cannot be constructed (have pure virtual methods but no helper class)");
    return -1;
}

static PyMethodDef PyNs3Ipv4ClickRouting_methods[] = {
    {NULL, NULL, 0, NULL}
};

static void
PyNs3Ipv4ClickRouting__tp_clear(PyNs3Ipv4ClickRouting *self)
{
    Py_CLEAR(self->inst_dict);
    if (self->obj) {
    ns3::Ipv4ClickRouting *tmp = self->obj;
    self->obj = NULL;
    tmp->Unref();
}
}
...
static int
PyNs3Ipv4ClickRouting__tp_traverse(PyNs3Ipv4ClickRouting *self, visitproc visit, void *arg)
{
    Py_VISIT(self->inst_dict);
...
static void
_wrap_PyNs3Ipv4ClickRouting__tp_dealloc(PyNs3Ipv4ClickRouting *self)
{
    std::map<void*, PyObject*>::iterator wrapper_lookup_iter;
    wrapper_lookup_iter = PyNs3ObjectBase_wrapper_registry.find((void *) self->obj);
    if (wrapper_lookup_iter != PyNs3ObjectBase_wrapper_registry.end()) {
    ...
    PyNs3Ipv4ClickRouting__tp_clear(self);
    self->ob_type->tp_free((PyObject*)self);
}

static PyObject*
_wrap_PyNs3Ipv4ClickRouting__tp_richcompare (PyNs3Ipv4ClickRouting *PYBINDGEN_UNUSED(self), PyNs3Ipv4ClickRouting *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3Ipv4ClickRouting_Type)) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    switch (opid)
...
PyTypeObject PyNs3Ipv4ClickRouting_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "click.Ipv4ClickRouting",            /* tp_name */
    sizeof(PyNs3Ipv4ClickRouting),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3Ipv4ClickRouting__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
    (cmpfunc)NULL,           /* tp_compare */
    ...
    Py_TPFLAGS_BASETYPE|Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_GC,                      /* tp_flags */
    NULL,                        /* Documentation string */
    (traverseproc)PyNs3Ipv4ClickRouting__tp_traverse,     /* tp_traverse */
    (inquiry)PyNs3Ipv4ClickRouting__tp_clear,             /* tp_clear */
    (richcmpfunc)_wrap_PyNs3Ipv4ClickRouting__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3Ipv4ClickRouting_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyNs3Ipv4ClickRouting, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3Ipv4ClickRouting__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
PyTypeObject Pystd__map__lt___unsigned_int__unsigned_int___gt___Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "click.Std__map__lt___unsigned_int__unsigned_int___gt__",            /* tp_name */
...
PyTypeObject Pystd__map__lt___unsigned_int__unsigned_int___gt__Iter_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "click.Std__map__lt___unsigned_int__unsigned_int___gt__Iter",            /* tp_name */
...
initclick(void)
{
    PyObject *m;
    PyObject *submodule;
    m = Py_InitModule3((char *) "click", click_functions, NULL);
    if (m == NULL) {
        return;
    }
    ...
    PyNs3SimpleRefCount__Ns3Object_Ns3ObjectBase_Ns3ObjectDeleter__typeid_map.register_wrapper(typeid(ns3::Ipv4L3ClickProtocol), &PyNs3Ipv4L3ClickProtocol_Type);
    /* Register the 'ns3::Ipv4L3ClickProtocol' class */
    PyNs3Ipv4L3ClickProtocol_Type.tp_base = &PyNs3Ipv4_Type;
    if (PyType_Ready(&PyNs3Ipv4L3ClickProtocol_Type)) {
        return;
    }
    PyModule_AddObject(m, (char *) "Ipv4L3ClickProtocol", (PyObject *) &PyNs3Ipv4L3ClickProtocol_Type);
    PyNs3SimpleRefCount__Ns3Object_Ns3ObjectBase_Ns3ObjectDeleter__typeid_map.register_wrapper(typeid(ns3::Ipv4ClickRouting), &PyNs3Ipv4ClickRouting_Type);
    /* Register the 'ns3::Ipv4ClickRouting' class */
    PyNs3Ipv4ClickRouting_Type.tp_base = &PyNs3Ipv4RoutingProtocol_Type;
    if (PyType_Ready(&PyNs3Ipv4ClickRouting_Type)) {
        return;
    }
    PyModule_AddObject(m, (char *) "Ipv4ClickRouting", (PyObject *) &PyNs3Ipv4ClickRouting_Type);
