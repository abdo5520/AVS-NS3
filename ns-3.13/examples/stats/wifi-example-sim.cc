...
int main (int argc, char *argv[]) {
  ...
  // Create a counter to track how many MAC frames are generated.  Updates
  ...
  // This counter tracks how many Transport Layer packets ( given that the application does not create packets larger than
  // the maximum Packet Data Unit (PDU) ---as opposed to frames---are
